...
#if HAL_I2C_MASTER
extern void HalI2CInit(i2cClock_t clockRate);
extern i2cLen_t HalI2CRead(uint8 address, i2cLen_t len, uint8 *pBuf);
extern i2cLen_t HalI2CWrite(uint8 address, i2cLen_t len, uint8 *pBuf);
#else
extern void HalI2CInit(uint8 address, i2cCallback_t i2cCallback);
extern i2cLen_t HalI2CRead(i2cLen_t len, uint8 *pBuf);
extern i2cLen_t HalI2CWrite(i2cLen_t len, uint8 *pBuf);
#if HAL_I2C_POLLED
extern void HalI2CPoll(void);
#endif
#endif
extern uint8 HalI2CReady2Sleep(void);
extern void HalI2CEnterSleep(void);
extern void HalI2CExitSleep(void);
